        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left rtl:lg:text-right">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl">{t("subtitle")}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 rounded-lg bg-gray-50 dark:bg-gray-700">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Interactive Courses</h3>
              <p className="text-gray-600 dark:text-gray-300">
