    ...
    <div className="flex flex-col md:flex-row items-center gap-5 md:justify-between px-1 py-5 md:py-20 md:px-20 bg-white dark:bg-primary">
      <div className="flex flex-col gap-3 w-full items-center md:items-start md:w-1/2 ">
        ...
        <p className="text-lg text-gray-700 dark:text-gray-200">
          نحن في المعلم الذكي نؤمن أن المعرفة متاحة للجميع، وأن التكنولوجيا يمكن
          أن تكون الجسر الذي يربط الطالب بالمعلومة بشكل أسرع وأسهل وأكثر متعة.
          نسعى جاهدين لتوفير بيئة تعليمية تفاعلية، تُشجع على الفهم العميق بدلاً
          من الحفظ، وتُمكّن الطلاب من تطوير مهاراتهم الأكاديمية والشخصية.
        </p>
        <Link href={`/subjects`}>
          <Button
            size="lg"
