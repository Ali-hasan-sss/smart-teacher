    ...
    <nav className="absolute top-0 left-0 w-full z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="hidden md:flex items-center justify-between h-20 pt-4">
          ...
          <div className="absolute left-1/2 top-2 w-[60vw] max-w-7xl transform -translate-x-1/2 mt-2 bg-white dark:bg-gray-800 rounded-full shadow-md flex items-center justify-between px-6 py-2">
            {/* Logo and Navigation */}
